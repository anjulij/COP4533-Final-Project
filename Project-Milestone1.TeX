...
\section*{Project}
Group members (names, emails and GitHub accounts),
Member Roles, Communication method, Project Gantt Chart (including internal deadlines and
meetings), GitHub repository link, and solution to the three working examples.
